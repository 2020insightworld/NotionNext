...
const BLOG = {
  ...
  CONTACT_EMAIL: '2020insightworld@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '@20Insightworld', // 你的twitter个人主页
  ...
  CUSTOM_FONT_URL: ['https://fonts.googleapis.com/css2?family=Noto+Sans+TC:wght@100;300&display=swap'], // 自定义字体的CSS
